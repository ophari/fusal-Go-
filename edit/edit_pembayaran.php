...
<body>
    ...
    <div class="row mb-3">
                ...
                <input type="text" placeholder="id_pendaftar" name="id_pendaftar" value="<?php echo $data['id_pendaftar'] ?>">
                <label for="">jenis lapangan</label>
                <select name="jenis_lapangan" value="<?php echo $data['status_pembayaran'] ?>">
            ...
            <div class="col-sm-3 d-grid">
                <a class="btn btn-outline-primary" href="table_pembayaran.php" name="proses" role="button">Cancel</a>
            </div>
          </div>
        </form>
    </div>
